...
if (10 > 15) { // if is true, this block is executed.
    alert("Hello world!");
}

else if (15 == 10) { // this block is executed just when the first condition is false.
    alert("Hello world x2");
}

else {
    alert("No more hello words..."); // When nothing is true.
}
